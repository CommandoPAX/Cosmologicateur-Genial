...
if __name__ == "__main__" :
    ...
    for i in [1]:
        ...
        plt.loglog(PNG_1.k[4], PNG_1.P[4]/lcdm.P[i], label =r"fnl = 500 2")
        plt.loglog(PNG_2.k[4], PNG_2.P[4]/lcdm.P[i], label =r"fnl = 500 3")
        plt.loglog(PNG_3.k[4], PNG_3.P[4]/lcdm.P[i], label =r"fnl = 500 4")
        plt.loglog(PNG_4.k[4], PNG_4.P[4]/lcdm.P[i], label =r"fnl = 500 5")

        
        n +=1

        if i == 1 or i == 2 : axes.set_ylabel(r"P/P$_{\rm CDM}$")
