...
/softs/disperse/0.9.24/bin/mse $path_dat$file".fits" -cut $persistence -nthreads 32 -upSkl -manifolds -outName $path$file -periodicity 0 -forceLoops


#/softs/disperse/0.9.24/bin/skelconv $path$file"_c"$persistence".up.NDskl" -outName $path$file"_c"$persistence".up.NDskl" -smooth $smoothing -to segs_ascii
