...
if type_mono == "cdm":
    ...
    os.system("rm -fr ../monofonic_exp/build ; pause")
    os.system("mkdir ../monofonic_exp/build ; pause")
    os.system("cd ../monofonic_exp/build ; cmake .. ; pause" )
    os.system("cd ../monofonic_exp/build ; make ; pause")
    os.system("cd ../monofonic_exp; build/monofonIC ./PNG/NG.conf ; pause")
    os.system("cp ../monofonic_exp/ics_ramses/ic_poscx ../monofonic_exp/ics_ramses/ic_deltab ; pause")
os.system("cd ../ramses/bin; make clean ; pause")
os.system("cd ../ramses/bin; make NDIM=3 ; pause")
