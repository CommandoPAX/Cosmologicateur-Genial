...
if __name__ == "__main__" :
    ...
    for i in [1,2,3,4]:
        lcdm = np.load(f"/data100/fcastillo/RESULT/{snapshots[0]}/{i}_halos_s1_connect_fil.txt.npy")
        ...
        for d in range(2):
            ...
            for j in range(6):
                ...
                try :
                    ...
                    connect = np.load(f"/data100/fcastillo/RESULT/{snapshots[j]}/{i}_halos_s1_connect_fil.txt.npy")
    ...
    plt.savefig(f"connect_halos_{nbins}.pdf")
    plt.savefig(f"connect_halos_{nbins}.png")
    ...
    for i in range(6):
        ...
        for j in range(5):
            try :
                ...
                connect = np.load(f"/data100/fcastillo/RESULT/{snapshots[i]}/{j}_halos_s1_connect_fil.txt.npy")
    ...
    plt.savefig(f"connect_moyenne_halos.pdf")
    plt.savefig(f"connect_moyenne_halos.png")
